...
`invoice_no` = "' . $invoice_no . '", `booking_mode` = "' . $booking_mode . '", `total_freight` = "' . $total_freight . '", `mode` = "' . $mode . '",
`pickup_date_time` = "' . $pickup_date_time . '", `est_time_of_arrival` = "' . $est_time_of_arrival . '", `status` = "' . $status . '",
`current_loc` = "' . $current_loc . '", `comment` = "' . $comment . '", `comment2` = "' . $comment2 . '",
